...
<div style="max-width:1100px; margin:0 auto; padding:24px;">
    <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; margin-bottom:20px;">
        <div>
            <h1 style="margin:0;">Edit Pengiktirafan Profesional</h1>
    ...
    <form
        method="POST"
        action="{{ route('staff.professional-recognitions.update', [$staff, $professionalRecognition]) }}"
    >
        @csrf
        @method('PUT')

        @include('staff.professional-recognitions._form')
